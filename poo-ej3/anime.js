export default class Anime {
   ...
   async obtenerDatos()
     {
         const datos = await fetch("https://api.jikan.moe/v3/search/anime?q=blood%20c") 

         const datos_json = await datos.json()

         //* accedimos a results, que seria nuestro arreglo a recorrer
         ...
         lista.forEach(element => {
            ...
            let columna = ` 
                ...
                <div class="row g-0">
                    <div class="col-md-4">
                    <img src="${element.image_url}" class="img-fluid rounded-start"alt="${element.tittle}">
                    </div>
                    <div class="col-md-8">
                    <div class="card-body">
